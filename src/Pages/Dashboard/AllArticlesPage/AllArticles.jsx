...
import { Shield, Trash2, Star, AlertCircle, CheckCircle, XCircle, ChevronLeft, ChevronRight } from "lucide-react"
...
const AllArticles = () => {
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      try {
        const response = await axiosSecure.get(`/articless?page=${currentPage}&limit=${itemsPerPage}`)
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-7xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="overflow-x-auto p-6">
          {articles.length === 0 ? (
            <p className="text-center text-gray-500 py-8">No articles available</p>
          ) : (
            <>
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-4 flex justify-between items-center">
                      <div className="flex items-center space-x-4">
                        <img
                          src={article.AuthorImage || "/api/placeholder/40/40"}
                          alt={article.name}
